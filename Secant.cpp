...
class Secant
{
	...
	public:
		...
		Secant(double a,double b,int dp):a(a),b(b),check(1),line("__________________________________________________________________________"),dp(dp)
		{
			error = 0.5;
			for(int i=0;i<dp;i++)
			{
